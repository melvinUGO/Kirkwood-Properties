...
const Projects = () => {
  return (
    <section id="projects" className=" pt-36 px-5 sm:px-9 lg:px-0 ">
      <div className="flex flex-col  gap-10 lg:flex-row justify-between lg:items-center">
        ...
        <div className=" text-center md:text-left ">
          ...
          <p className=" lg:max-w-[410px]">
            Experience the epitome of modern living with our state-of-the-art
            amenities, breathtaking views, and prime locations, ensuring an
            extraordinary lifestyle beyond compare.
          </p>
        </div>
      </div>
              ...
              <article className="project-box relative bg-kirkwood-blue w-[300px]  sm:w-[330px] lg:w-[410px] xl:w-[490px] h-[481px] mx-auto">
                <div className=" absolute bg-kirkwood-blue -bottom-8 -right-8 w-[300px] sm:w-[330px] lg:w-[410px] xl:w-[490px] h-[481px]">
                  ...
                  <div className=" absolute top-0 left-0 overlay p-5 text-center text-white z-30">
                    ...
                    <p className="text-white pb-10">{project.slogan}</p>
                    <Link
      ...
      <div>
        <h2 className="py-0 text-center">SOME PAST PROJECTS</h2>
