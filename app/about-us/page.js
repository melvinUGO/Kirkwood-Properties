        ...
        <div className=" my-10 overflow-hidden flex flex-col gap-5 md:gap-0 md:flex-row shadow-2xl max-w-[1200px] mx-auto">
          <article className="w-full h-[476px] pb-10 lg:shadow-lg bg-white">
            ...
            <div className=" pt-4 px-8">
              ...
              <p>
                Kirkwood Properties creates tranquil and secure residential
                spaces for residents. Our properties are free from noise and
                crime, and our residents feel safe and at peace in their homes.
              </p>
            </div>
          </article>
          <article className="w-full h-[476px] pb-10 lg:shadow-lg bg-white">
